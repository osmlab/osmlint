    ...
    if (preserveType[highway.properties.highway] && highway.geometry.type === 'LineString') {
      if (
        ...
        !(
          ...
          highway.geometry.coordinates[0][0] !== highway.geometry.coordinates[2][0] &&
          highway.geometry.coordinates[0][1] !== highway.geometry.coordinates[2][1]
        )
      ) {
      ...
      for (var f = 0; f < arrayWays.length; f++) {
        if (
          ...
          !(
            ...
            arrayWays[f].geometry.coordinates[0][0] !== arrayWays[f].geometry.coordinates[2][0] &&
            arrayWays[f].geometry.coordinates[0][1] !== highway.geometry.coordinates[2][1]
          )
        ) {
